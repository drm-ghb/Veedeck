...
export default function TrialExpiredModal() {
  ...
  const inputCls =
    "w-full px-3.5 py-2.5 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 transition-all bg-white border border-gray-200 text-gray-900 placeholder-gray-400";
