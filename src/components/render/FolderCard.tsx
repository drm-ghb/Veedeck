...
export default function FolderCard({ folder, projectId, roomId }: FolderCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-5 shadow-sm hover:shadow-[0_4px_16px_rgba(25,33,61,0.2)] hover:border-[#C45824]/30 transition-all"
    >
